...
/// The coordinate system itself is setup as in Vulkan with X axis pointing to the right, Y axis pointing downwards and Z axis pointing from the camera so it's right-handed.
